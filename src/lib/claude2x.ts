...
// DST starts March 8, 2026 — all US clocks are ahead (EDT/PDT) for entire promo
export const PROMO_START = dayjs.utc("2026-03-13 04:00:00") // March 13 00:00 EDT
export const PROMO_END = dayjs.utc("2026-03-28 07:00:00") // March 28 00:00 PDT (end of March 27)
